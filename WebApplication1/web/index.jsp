...
<% String jsp = request.getAttribute("page").toString(); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Title -->
    ...
    <!-- Template -->
    <link rel="stylesheet" href="assets/public/graindashboard/css/graindashboard.css">
</head>
    ...
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="/">
                <img class="img-fluid w-100" src="assets/public/img/logo-mini.png" alt="Graindashboard">
            </a>
            <!-- End Logo For Mobile View -->

            <!-- Logo For Desktop View -->
            <a class="navbar-brand navbar-brand-desktop" href="/">
                <img class="side-nav-show-on-closed" src="assets/public/img/logo-mini.png" alt="Graindashboard" style="width: auto; height: 33px;">
                <img class="side-nav-hide-on-closed" src="assets/public/img/logo.png" alt="Graindashboard" style="width: auto; height: 33px;">
            </a>
            ...
            <li class="side-nav-menu-item side-nav-has-menu side-nav-opened">
                <a class="side-nav-menu-link media align-items-center" href="#"
                  ...
                  <span class="side-nav-menu-icon d-flex mr-3">
                    ...
                    <span class="side-nav-fadeout-on-closed media-body">List</span>
                ...
                <!-- Add subList -->
                <ul id="subList" class="side-nav-menu side-nav-menu-second-level mb-0" style="display: block;">
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="GetAllServlet?page=listActivite.jsp">vers liste Activite</a>
                    </li>
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="GetAllServlet?page=listBouquet.jsp">vers liste Bouquet</a>
                    </li>
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="GetAllServlet?page=listCategorieLieu.jsp">vers liste Categorie Lieu</a>
                    </li>
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="GetAllServlet?page=listLieu.jsp">vers liste Lieu</a>
                    </li>
                </ul>
                <!-- End List subList -->
            </li>
            ...
            <li class="side-nav-menu-item side-nav-has-menu side-nav-opened">
                <a class="side-nav-menu-link media align-items-center" href="#"
                  ...
                  <span class="side-nav-menu-icon d-flex mr-3">
                    ...
                    <span class="side-nav-fadeout-on-closed media-body">Add</span>
                    <span class="side-nav-control-icon d-flex">
                <i class="gd-angle-right side-nav-fadeout-on-closed"></i>
              </span>
                    <span class="side-nav__indicator side-nav-fadeout-on-closed"></span>
                ...
                <!-- Add subAdd -->
                <ul id="subAdd" class="side-nav-menu side-nav-menu-second-level mb-0" style="display: block;">
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="RedirectServlet?page=ajouterActivite.jsp">vers ajouter Activite</a>
                    </li>
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="RedirectServlet?page=ajouterBouquet.jsp">vers ajouter Bouquet</a>
                    </li>
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="RedirectServlet?page=ajouterLieu.jsp">vers ajouter Lieu</a>
                    </li>
                    <li class="side-nav-menu-item">
                        <a class="side-nav-menu-link" href="RedirectServlet?page=ajouterCategorieLieu.jsp">vers ajouter Categorie lieu</a>
                    </li>
                </ul>
                <!-- End Add subAdd -->
            </li>
...
<script src="assets/public/graindashboard/js/graindashboard.js"></script>
<script src="assets/public/graindashboard/js/graindashboard.vendor.js"></script>
