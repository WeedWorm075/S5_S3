<%-- 
    ...
    Created on : 12 déc. 2023, 14:33:37
    Author     : Sleep_Boo
--%>
        ...
        <div class="py-4 px-3 px-md-4">
            <div class="card mb-3 mb-md-4">
                ...
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <div>
                        <form action="CategorieLieuServlet" method="post">
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    <label for="idCategorieLieu">id</label>
                                    <input type="number" class="form-control" value="" id="idCategorieLieu" name="idCategorieLieu" placeholder="id">
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    <label for="nomCategorieLieu">nomCategorieLieu</label>
                                    <input type="text" class="form-control" value="" id="nomActivite" name="nomCategorieLieu" placeholder="nom CategorieLieu">
                                </div>
